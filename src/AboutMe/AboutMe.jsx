    ...
    render(){
        return (
            <div className='pure-g about-me'>
             ...
             <a href="" className='pure-u-1-4'><FontAwesomeIcon icon={["fab", "facebook"]} /></a>
             <a href="" className='pure-u-1-4'><FontAwesomeIcon icon={["fab", "twitter"]} /></a>
             <a href="" className='pure-u-1-4'><FontAwesomeIcon icon={["fab", "instagram"]} /></a>
             <a href="" className='pure-u-1-4'><FontAwesomeIcon icon={["fab", "linkedin"]} /></a>
